...
```bash
npm add https://github.com/ndimares/test-sdk
```

### Yarn

```bash
yarn add https://github.com/ndimares/test-sdk
```
...
} from "Superstore/dist/sdk/models/operations";

import { AxiosError } from "axios";
import { SDK } from "Superstore";
const sdk = new SDK({
  security: {
